...
>
  <svg width="160" height="120" viewBox="0 0 200 150">
    <g
      class="bubble-group"
      style="--c:#bd63ee; --offset:0s;   --start:translate(60px,130px);  --mid:translate(64px,78px);  --top:translate(68px,45px);"
    >
    ...
    <g
      class="bubble-group"
      style="--c:#6363ee; --offset:1.4s; --start:translate(100px,130px); --mid:translate(96px,78px); --top:translate(92px,45px);"
    >
      <circle class="bubble-circle" r="12" />
      <g class="particles">
        <circle
...
<style>
  ...
  .logo-container:not(.ready) .bubble-group {
    transform: var(--start);
  }
