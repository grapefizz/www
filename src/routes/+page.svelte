  ...
  <div class="container">
    <div class="row">
      ...
      <div
        ...
        role="img"
        aria-label="Fizzy bubbles logo"
      >
        <svg width="160" height="120" viewBox="0 0 200 150">
          <g
            class="bubble-group"
            style="--c:#bd63ee; --offset:0s;   --start:translate(60px,130px);  --mid:translate(68px,78px);  --top:translate(75px,45px);"
          >
            ...
            <g class="particles">
              <circle
                class="particle"
                r="2"
                style="--dx:0;   --dy:-14; --pdelay:0s;    --vx:0;   --vy:-8; --drag:0.95;"
              />
              <circle
                class="particle"
                r="2"
                style="--dx:11;  --dy:-6;  --pdelay:0.015s; --vx:6;   --vy:-3; --drag:0.92;"
              />
              <circle
                class="particle"
                r="2"
                style="--dx:10;  --dy:8;   --pdelay:0.03s;  --vx:5;   --vy:4;  --drag:0.88;"
              />
              <circle
                class="particle"
                r="2"
                style="--dx:-7;  --dy:11;  --pdelay:0.045s; --vx:-4;  --vy:6;  --drag:0.90;"
              />
              <circle
                class="particle"
                r="2"
                style="--dx:-12; --dy:-3;  --pdelay:0.06s;  --vx:-7;  --vy:-2; --drag:0.93;"
              />
            </g>
          </g>
          <g
            class="bubble-group"
            style="--c:#6363ee; --offset:1.4s; --start:translate(100px,130px); --mid:translate(92px,78px); --top:translate(85px,45px);"
          >
            <circle class="bubble-circle" r="12" />
            <g class="particles">
              <circle
                class="particle"
                r="2"
                style="--dx:0;   --dy:-14; --pdelay:0s;    --vx:0;   --vy:-9; --drag:0.94;"
              />
              <circle
                class="particle"
                r="2"
                style="--dx:12;  --dy:-8;  --pdelay:0.018s; --vx:7;   --vy:-4; --drag:0.91;"
              />
              <circle
                class="particle"
                r="2"
                style="--dx:13;  --dy:3;   --pdelay:0.036s; --vx:8;   --vy:2;  --drag:0.89;"
              />
              <circle
                class="particle"
                r="2"
                style="--dx:5;   --dy:12;  --pdelay:0.054s; --vx:3;   --vy:7;  --drag:0.87;"
              />
              <circle
                class="particle"
                r="2"
                style="--dx:-11; --dy:6;   --pdelay:0.072s; --vx:-6;  --vy:3;  --drag:0.92;"
              />
            </g>
          </g>
          <g
            class="bubble-group"
            style="--c:#26bbd9; --offset:2.8s; --start:translate(80px,130px);  --mid:translate(80px,68px);  --top:translate(80px,30px);"
          >
            <circle class="bubble-circle" r="12" />
            <g class="particles">
              <circle
                class="particle"
                r="2"
                style="--dx:0;   --dy:-14; --pdelay:0s;    --vx:0;   --vy:-7; --drag:0.96;"
              />
              <circle
                class="particle"
                r="2"
                style="--dx:14;  --dy:0;   --pdelay:0.012s; --vx:8;   --vy:0;  --drag:0.90;"
              />
              <circle
                class="particle"
                r="2"
                style="--dx:9;   --dy:11;  --pdelay:0.024s; --vx:5;   --vy:6;  --drag:0.88;"
              />
              <circle
                class="particle"
                r="2"
                style="--dx:-9;  --dy:11;  --pdelay:0.036s; --vx:-5;  --vy:6;  --drag:0.91;"
              />
              <circle
                class="particle"
                r="2"
                style="--dx:-14; --dy:0;   --pdelay:0.048s; --vx:-8;  --vy:0;  --drag:0.89;"
              />
            </g>
          </g>
        </svg>
    ...
    <nav>
      ...
      <a class="nav" href="/projects"
        ><span class="arrow">-></span><span class="slash">/</span>projects</a
      >
      <a class="nav" href="/blog"
        ><span class="arrow">-></span><span class="slash">/</span>blog</a
      >
      <a class="nav" href="/pics"
        ><span class="arrow">-></span><span class="slash">/</span>pics</a
      >
      <a class="nav" href="/contact"
        ><span class="arrow">-></span><span class="slash">/</span>contact</a
      >
    </nav>
  </div>
</main>
...
<style>
  ...
  .svg-container:not(.ready) .bubble-group {
    transform: var(--start);
  }
  ...
  @keyframes particleBurst {
    ...
    94% {
      ...
      transform: translate(
          calc(
            var(--dx) * 1px + var(--vx) * 5px * var(--drag) * var(--drag) *
              var(--drag)
          ),
    ...
    97% {
      ...
      transform: translate(
          calc(
            var(--dx) * 1px + var(--vx) * 5.2px * var(--drag) * var(--drag) *
              var(--drag)
          ),
